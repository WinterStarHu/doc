...
**See Also:**   CREATE TABLESPACE and ALTER TABLESPACE for information on creating and modifying a tablespace
## Prerequisites
...
## Syntax
## *drop_tablespace*::=
Description of the illustration drop_tablespace.eps
## Semantics
## IF EXISTS
