...
## Syntax
## *alter_operator*::=
Description of the illustration alter_operator.eps
(*add_binding_clause::=*, *drop_binding_clause::=*)
## *add_binding_clause*::=
Description of the illustration add_binding_clause.eps
(*implementation_clause::=*, *using_function_clause::=*)
## *implementation_clause*::=
Description of the illustration implementation_clause.eps
(*context_clause::=*)
## *context_clause*::=
Description of the illustration context_clause.eps
## *using_function_clause*::=
Description of the illustration using_function_clause.eps
## *drop_binding_clause*::=
Description of the illustration drop_binding_clause.eps
## Semantics
## IF EXISTS
