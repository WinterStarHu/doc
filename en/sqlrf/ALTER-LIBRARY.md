...
**Note:**   This statement does not change the declaration or definition of an existing library. To redeclare or redefine a library, use the “CREATE LIBRARY” with the `OR` `REPLACE` clause.
## Prerequisites
