...
Description of the illustration drop_lockdown_profile.eps
## Semantics
## *profile_name*
...
**See Also:**   *Oracle Database Reference* for more information on the `DBA_LOCKDOWN_PROFILES` data dictionary view and the `PDB_LOCKDOWN` initialization parameter
## Example
