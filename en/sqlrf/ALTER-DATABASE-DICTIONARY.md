...
## Prerequisites
  ...
  - Keystore is open.
**
  - Master Encryption Key exists in the TDE keystore. If any of the checks fail, the DDL fails. When this happens you must create a TDE keystore and provision a TDE Master Key. For more see the Database Security Guide.
...
Description of the illustration alter_database_dictionary.eps
## Semantics
...
**See Also:**    *Managing Security for Application Developers* in the *Database Security Guide*
