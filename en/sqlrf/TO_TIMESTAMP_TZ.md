...
Description of the illustration to_timestamp_tz.eps
## Purpose
...
**Note:**   This function does not convert character strings to `TIMESTAMP` `WITH` `LOCAL` `TIME` `ZONE`. To do this, use a `CAST` function, as shown in CAST.
