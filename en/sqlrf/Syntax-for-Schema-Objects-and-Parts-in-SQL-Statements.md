...
Description of the illustration database_object_or_part.eps
(dblink::=)
where:
**
...
Description of the illustration dblink.eps
where:
****
...
**See Also:**    *Oracle Database Administrator’s Guide* for more information on connection qualifiers
...
**See Also:**   The `CREATE` `TABLE` INTERVAL Clause for more information on interval partitions
