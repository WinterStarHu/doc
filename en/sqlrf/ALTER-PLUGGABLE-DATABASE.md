...
Description of the illustration alter_pluggable_database.eps
...
## *pdb_unplug_encrypt*::=
Description of the illustration pdb_unplug_encrypt.eps
...
(*size_clause::=*)
## *pdb_logging_clauses*::=
Description of the illustration pdb_logging_clauses.eps
## *logging_clause*::=
Description of the illustration logging_clause.eps
## *pdb_force_logging_clause*::=
Description of the illustration pdb_force_logging_clause.eps
## *pdb_refresh_mode_clause*::=
Description of the illustration pdb_refresh_mode_clause.eps
## *pdb_refresh_switchover_clause*::=
Description of the illustration pdb_refresh_switchover_clause.eps
## *pdb_datafile_clause*::=
Description of the illustration pdb_datafile_clause.eps
## *pdb_recovery_clauses*
Description of the illustration pdb_recovery_clauses.eps
## *pdb_general_recovery*::=
Description of the illustration pdb_general_recovery.eps
## *pdb_change_state*::=
Description of the illustration pdb_change_state.eps
(*pdb_open::=*, *pdb_close::=*, *pdb_save_or_discard_state::=*)
## *pdb_open*::=
Description of the illustration pdb_open.eps
## *instances_clause*::=
Description of the illustration instances_clause.eps
## *services_clause*::=
Description of the illustration services_clause.eps
## *pdb_close*::=
Description of the illustration pdb_close.eps
## *relocate_clause*::=
Description of the illustration relocate_clause.eps
## *pdb_save_or_discard_state*::=
Description of the illustration pdb_save_or_discard_state.eps
## *pdb_change_state_from_root*::=
Description of the illustration pdb_change_state_from_root.eps
(*pdb_open::=*, *pdb_close::=*, *pdb_save_or_discard_state::=*)
## *application_clauses*::=
Description of the illustration application_clauses.eps
## *snapshot_clauses*::=
Description of the illustration snapshot_clauses.eps
## *pdb_snapshot_clause*::=
Description of the illustration pdb_snapshot_clause.gif
Description of the illustration pdb_snapshot_clause.eps
## *materialize_clause*::=
Description of the illustration materialize_clause.eps
## *create_snapshot_clause*::=
Description of the illustration create_snapshot_clause.eps
## *drop_snapshot_clause*::=
Description of the illustration drop_snapshot_clause.eps
## *set_max_pdb_snapshots*::=
Description of the illustration set_max_pdb_snapshots_clause.eps
## *prepare_clause*::=
...
```
  ...
  **See Also:**
  - [*Oracle Database Administrator's Guide*](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/19/sqlrf&id=ADMIN13623) for more information on unplugging a PDB
  - The *[create_pdb_from_xml](CREATE-PLUGGABLE-DATABASE.html#GUID-F2DBA8DD-EEA8-4BB7-A07F-78DC04DB1FFC\_\_CACJHJFE)* clause of `CREATE` `PLUGGABLE` `DATABASE` for information on plugging a PDB into a CDB
  </div>
```
## *pdb_unplug_encrypt*
 ...
 **Note:**   When you change the global name of a PDB, be sure to change the `PLUGGABLE` `DATABASE` property for database services that are used to connect to the PDB.
...
````******
- Specify DISABLE RECOVERY to take all data files that belong to a PDB offline and disable the PDB for recovery. See Also: Oracle Data Guard Concepts and Administration for more information on the RECOVERY clauses
## *pdb_change_state*
...
**See Also:**   *Oracle Database Backup and Recovery User’s Guide* for more information on performing point-in-time recovery of CDBs and PDBs
***instances_clause***
...
**See Also:**   [*SQL*Plus User’s Guide and Reference*](/pls/topic/lookup?ctx=en/database/oracle/oracle-database/19/sqlrf&id=SQPUG125) for more information on the SQL*Plus `SHUTDOWN` command
**ABORT**
...
******
- Sync applications between the application root and application PDBs See Also: Oracle Database Administrator’s Guide for more information on administering application containers
