...
                                            Document History
 ...
 2008                                   5.4.6, 8.4.2.2 and 9.2.6.1 to refer to pricing specification. Update TPC
                                        member companies.

 17 September        Revision 2.9.0     Add Clause 8.3.5.10 to require wording for memory-to-scale factor
...
4.2.5.1 Table 3: Estimated Database Size shows the test database size for a scale factor, SF, of 1.
         Table 3: Estimated Database Size
             ...
             Table Name                    Cardinality       Length (in bytes)      Typical2 Table
                                           (in rows)         of Typical2 Row        Size (in MB)
         ...
         2
             Typical lengths and sizes given here are examples, not requirements, of what could result from an
                   implementation (sizes do not include storage/access overheads).
         3
             The cardinality of the LINEITEM table is not a strict multiple of SF since the number of lineitems in an
...
        Where:
        QI(i,0) is the timing interval, in seconds, of query Q i within the single query stream of the power test (see
                  Clause 5.3.7)
...
metric of 3,010,324 yielding a TPC-H Price/Performance of $68.21 per 1000 query-per-hour and will be available 1-
Apr-99.
...
               QGEN Modifications         benchmark_scripts.zip   SupportingFiles/Clause2/QGEN.txt
               ...
               Minor query                benchmark_scripts.zip
  ...
  Clause 3
               ...
               Qualification db           benchmark_scripts.zip
                                                                  SupportingFiles/Clause4/QualResults/
               differences

  Clause 4     DBGEN Modifications        benchmark_scripts.zip   SupportingFiles/Clause4/DBGEN.txt
  ...
  Clause 7     required to be included             n/a            n/a
               ...
               Horizontal Partitioning    benchmark_scripts.zip
  ...
  Clause 8
               Query substitution         benchmark_scripts.zip
