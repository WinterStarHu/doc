...
**Note:**   Oracle recommends that you perform a full backup of all files in the database before using this statement. For more information, see *Oracle Database Backup and Recovery User’s Guide*.
## Purpose
...
## Syntax
## *create_controlfile*::=
Description of the illustration create_controlfile.eps
(*storage_clause::=*)
## *logfile_clause*::=
Description of the illustration logfile_clause.eps
(*file_specification::=*)
## *character_set_clause*::=
Description of the illustration character_set_clause.eps
## Semantics
...
**See Also:**   *ASM_filename* for information on the different forms of syntax and *Oracle Automatic Storage Management Administrator’s Guide* for general information about using Oracle ASM
## GROUP*integer*
...
**See Also:**    *Oracle Automatic Storage Management Administrator’s Guide* for general information about using Oracle ASM
