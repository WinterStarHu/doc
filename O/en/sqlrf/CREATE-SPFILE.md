...
## Syntax
## *create_spfile*::=
Description of the illustration create_spfile.eps
## Semantics
## *spfile_name*
...
```
  ...
  **See Also:**
  - "[Creating a Server Parameter File: Examples](CREATE-SPFILE.html#GUID-D3E295B7-A3A4-43D3-8BBD-5CBE171A2E52\_\_I2087518)" for information on starting up the database with default and nondefault server parameter files
...
The following example creates a default server parameter file from a traditional plain-text parameter file named `t_init
1.ora`:
```
CREATE SPFILE
