...
## Syntax
## *create_sequence*::=
Description of the illustration create_sequence.eps
## Semantics
## IF NOT EXISTS
...
## CACHE
Specify how many values of the sequence the database preallocates and keeps in memory for faster access. This integer value can have 28 or fewer digits. The minimum value for this parameter is
