...
**See Also:**   ALTER TABLESPACE SET and DROP TABLESPACE SET
## Prerequisites
...
Description of the illustration create_tablespace_set.eps
...
**``````````********````
- For the segment_management_clause, you can specify only SEGMENT SPACE MANAGEMENT AUTO. The MANUAL setting is not supported. See Also: file_specification and permanent_tablespace_attrs in the documentation on CREATE TABLESPACE for the full semantics of these clauses
## Examples
