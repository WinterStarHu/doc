...
**See Also:**   DROP TABLE and DROP INDEX for information on privileges required to drop objects that the database uses to maintain the zone map
## Syntax
## *drop_materialized_zonemap*::=
Description of the illustration drop_materialized_zonemap.eps
## Semantics
## IF EXISTS
Specify `IF EXISTS` to drop an existing zone map.
## *schema*
