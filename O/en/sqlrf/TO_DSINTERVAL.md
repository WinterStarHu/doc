...
Description of the illustration to_dsinterval.eps
## *sql_format*::=
Description of the illustration sql_format.gif
Description of the illustration sql_format.eps
## *ds_iso_format*::=
Description of the illustration ds_iso_format.gif
Description of the illustration ds_iso_format.eps
**Note:**   In earlier releases, the `TO_DSINTERVAL` function accepted an optional *nlsparam* clause. This clause is still accepted for backward compatibility, but has no effect.
## Purpose
