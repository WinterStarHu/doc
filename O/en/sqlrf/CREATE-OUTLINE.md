...
## Syntax
## *create_outline*::=
Description of the illustration create_outline.eps
...
****
- The SQL statement in the ON clause cannot include any DML operation on a remote object. Note: In subsequent statements, you can specify additional outlines for the same SQL statement, but each outline for the same statement must specify a different category in the CATEGORY clause.
## Examples
