...
Description of the illustration xmlelement.eps
## *XML_attributes_clause*::=
Description of the illustration xml_attributes_clause.gif
Description of the illustration xml_attributes_clause.eps
## Purpose
...
**See Also:**   “Extended Data Types” for more information on `MAX_STRING_SIZE`
...
**
****
- If value_expr is null, then no element is created for that value expression. See Also: SYS_XMLGEN
## Examples
