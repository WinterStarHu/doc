...
## Syntax
## *alter_audit_policy*::=
Description of the illustration alter_audit_policy.eps
**Note:**   If you specify the `ADD` or `DROP` clause, then you must specify at least one of the clauses *privilege_audit_clause*, *action_audit_clause*, or *role_audit_clause*.
