...
Description of the illustration create_rollback_segment.eps
(*storage_clause*)
## Semantics
## PUBLIC
...
```
  ...
  **Note:**
  ...
  </div>  **See Also:**   [CREATE TABLESPACE](CREATE-TABLESPACE.html#GUID-51F07BF5-EFAF-4910-9040-C473B86A8BF9)
```
## *storage_clause*
...
********
- You cannot specify the PCTINCREASE parameter of the storage_clause with CREATE ROLLBACK SEGMENT. See Also: storage_clause
## Examples
