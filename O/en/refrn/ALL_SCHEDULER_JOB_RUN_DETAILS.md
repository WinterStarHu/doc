...
|---|---|---|---|
| LOG_ID | NUMBER | NOT NULL | Unique identifier of the log entry (foreign key of the *_SCHEDULER_JOB_LOG views) |
...
| SLAVE_PID | VARCHAR2(30) |  | Process identifier of the worker on which the job was run |
